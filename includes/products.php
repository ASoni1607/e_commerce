...
<html>
    <head>
        ...
        <title>Lifestyle Shopping Products</title>
    </head>
    <body>
            ...
            <div class="row text-center">
                <div class="col-md-3 col-xs-6">
                    ...
                    <div class="thumbnail">
                              ...
                              <img src="img/5.jpg" alt="responsiv img">
                        <div class="caption">
                            <h3>Cannon EOS</h3>
 ...
 ?>
                ...
                <div class="col-md-3 col-xs-6">
                     <div class="thumbnail">
                        ...
                        <img src="img/2.jpg" alt="responsiv img">
                        <div class="caption">
                            <h3>Sony DSLR</h3>
 ...
 ?>
                ...
                <div class="col-md-3 col-xs-6">
                     <div class="thumbnail">
                        ...
                        <img src="img/3.jpg" alt="responsiv img">
                        <div class="caption">
                            <h3>Sony DSLR</h3>
 ...
 ?>
                    ...
                    <div class="col-md-3 col-xs-6">
                     <div class="thumbnail">
                        ...
                        <img src="img/4.jpg" alt="responsiv img">
                        <div class="caption">
                            <h3>Olympus DSLR</h3>
            ...
            <div class="row text-center">
                <div class="col-md-3 col-xs-6">
                    ...
                    <div class="thumbnail">
                              ...
                              <img src="img/9.jpg" alt="responsiv img">
                        <div class="caption">
 ...
 ?>
                ...
                <div class="col-md-3 col-xs-6">
                     <div class="thumbnail">
                        ...
                        <img src="img/10.jpg" alt="responsiv img">
                        <div class="caption">
 ...
 ?>
                ...
                <div class="col-md-3 col-xs-6">
                     <div class="thumbnail">
                        ...
                        <img src="img/11.jpg" alt="responsiv img">
                        <div class="caption">
                            <h3>HMT Milan</h3>
 ...
 ?>
                    ...
                    <div class="col-md-3 col-xs-6">
                     <div class="thumbnail">
                        ...
                        <img src="img/12.jpg" alt="responsiv img">
                        <div class="caption">
            ...
            <div class="row text-center">
                <div class="col-md-3 col-xs-6">
                    ...
                    <div class="thumbnail">
                              ...
                              <img src="img/8.jpg" alt="responsiv img">
                        <div class="caption">
                            <h3>H&W</h3>
                            <p>Price:Rs.800.00</p>
                                <?php if (!isset($_SESSION['email'])) { ?>
 ...
 ?>
                ...
                <div class="col-md-3 col-xs-6">
                     <div class="thumbnail">
                        ...
                        <img src="img/6.jpg" alt="responsiv img">
                        <div class="caption">
                            <h3>Luis Phil</h3>
 ...
 ?>
                ...
                <div class="col-md-3 col-xs-6">
                     <div class="thumbnail">
                        ...
                        <img src="img/13.jpg" alt="responsiv img">
                        <div class="caption">
                            <h3>Jhon Zok</h3>
